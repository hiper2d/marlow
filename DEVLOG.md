...
*State at end of day.* Voice now has both a sharper external rail and, for the first time, an internal one. Whether a self-authored voice *coheres* in the sandbox — or tips toward persona despite the guardrail — is now the thing to watch. Cleaner version of the original experiment, studied without the global tax.
