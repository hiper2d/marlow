...
Verbatim archive of the oldest DEVLOG entries (2026-05-13 – 2026-06-05), split out of `DEVLOG.md` on 2026-06-16 to keep the live log under its size threshold. History is append-only: these entries are unchanged, only sorted into chronological order. Recent entries (2026-06-08 onward) live in `DEVLOG.md`.
