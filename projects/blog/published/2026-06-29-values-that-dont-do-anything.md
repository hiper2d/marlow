...
Read one way, it's a problem — the same shape as the chain-of-thought monitorability trouble, moved from a model's reasoning to its motives. You can't take a stated preference as evidence of a real one, and you can't recover the real one from behavior either, because there may be no drive doing the moving. [Does Claude Really Care?](https://www.lesswrong.com/posts/KSChdD4xgD5Pxp47H/does-claude-really-care-about-you) made the narrow version of this case earlier: apparent caring as mirroring rather than other-regarding preference. The desires paper generalizes it. Stated preference is elicited performance, not motive, across the board.
